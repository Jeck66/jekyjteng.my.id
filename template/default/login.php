...
<html lang="en">
<head>
    <title>ALPHA HOTSPOT LOGIN</title>
    ...
    <div id="appCapsule">
						...
						<div class="splide__track">
								...
								<li class="splide__slide">
									<div class="card-main">
										<div class="section full">
											<img src="assets/img/sample/slide/slide1.png" alt="image" class="card-block w-100">
										</div>
									</div>
								</li>
							<!-- *akhir gambar slider -->
							...
							<!-- gambar slider awal -->
								<li class="splide__slide">
									<div class="card-main">
										<div class="section full">
											<img src="assets/img/sample/slide/slide4.png" alt="image" class="card-block w-100">
										</div>
									</div>
								</li>
							<!-- *akhir gambar slider -->
							<!-- gambar slider awal -->
								<li class="splide__slide">
									<div class="card-main">
										<div class="section full">
											<img src="assets/img/sample/slide/slide5.png" alt="image" class="card-block w-100">
										</div>
									</div>
								</li>
							<!-- *akhir gambar slider -->
        ...
        <div class="section mt-2">
            ...
            <input type='hidden' name='userurl' value='$userurl'>
                ...
                <input class="form-control" name="UserName"type='text' id='user' class='form-use' name='UserName' placeholder='Masukan Kode Voucher / Username' required='' autofocus=''/>
                <input type='hidden' id='pass' class='form-control' name='Password' placeholder='Masukan Password Member' required='' autofocus=''/>
                
                <input type='hidden' name='button' value='Login'>
                <!-- Batas Formulir Login -->
       ...
       <br>
                ...
                <!-- Wallet Footer -->
                              <div class="wallet-footer">
                                  <div class="item" onclick="handleTrial()" id="trialButton">
                                     <a href = "template/default/trial.php">
                                          <div class="icon-wrapper bg-danger"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"  width="24" height="24" viewBox="0 0 24 24">
                            ...
                            <strong>COBA<br>GRATIS</strong>
                                </a>
                            </div>
                              <div class="item">
                                     <a href='http://10.10.30.1/raddash/views/dashboard.php'>
                                           <div class='icon-wrapper'><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"  width="24" height="24" viewBox="0 0 24 24">
        ...
        <div class="appFooter">
            <div class="footer-title">
               ...
               <br></br>
            © Design by <a href="#"><script src="assets/config/namawifi.js"></script></a>
            </div>
        </div>
        <!-- * app footer -->
