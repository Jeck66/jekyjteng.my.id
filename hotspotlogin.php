...
if ($button == 'Login') {
  ...
  if (isset($uamsecret) && isset($userpassword) && $userpassword=="pap" ) {
    ...
    include('template/'.$template.'/redirect.php');
...
if (($result == 2) || ($result == 5) || ($result == 3) || ($result == 13)) {
	include('template/'.$template.'/login-header.php');
	include('template/'.$template.'/login.php');
	include('template/'.$template.'/login-footer.php');
}
...
if (($result == 4) || ($result == 12)) {
    include('template/'.$template.'/status.php');
}


if ($result == 11) {
        include('template/'.$template.'/login-popup.php');
}
